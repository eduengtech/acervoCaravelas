...
import { Roles } from 'src/modules/auth/decorators/roles.decorator';
    ...
    export class UsersController {
        ...
        create(@Body() data: CreateUsersDto, @Req() req){
            const userLoggedRole = req.user?.role || Role.ADMIN;
        ...
        update(@Param('id', ParseUUIDPipe) id: string, @Body() data: UpdateUserDto, @Req() req,) {
            return this.usersService.update(id, data, req.user.id, req.user.id.role);
        } 
